...
6. **Objekt-Target Dispatch ist “silent” bei fehlendem/nicht-callable handler** (keine onError/Diagnostics) — *silent gilt nur auf Handler-Ebene; fehlender/invalid `on` Entrypoint ist onError.*
